...
class ProductCategory(models.Model):
    ...
    icon_url = models.URLField(blank=True)  # blank = True (not required)
    descrption = models.TextField()  # (required)
...
class Product(models.Model):
    class Currency(models.TextChoices):
        SWIDISH_CROWN = ("SEK", _("Swedish Crown"))
        AMERICAN_DOLLAR = ("USD", _("Amercian Dollar"))
        EURO = ("EUR", _("Euro"))
        POUND_STERLING = ("GBP", _("Pound Sterling"))
        YEN = ("JPY", _("Yen"))
        AUSTRALIAN_DOLLAR = ("AUD", _("Australian Dollar"))
        SYRIAN_POUND = ("SYP", _("Syrian Pound"))
